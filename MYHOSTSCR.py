...
import atexit
import requests
from dotenv import load_dotenv  # New impot for .env
...
TOKEN = os.getenv('TOKEN', '8505527439:AAFdyPrns9SINQWndyAnbBrMg_NlGntBkBE')
OWNER_ID = int(os.getenv('OWNER_ID', 8581575196))
ADMIN_ID = int(os.getenv('ADMIN_ID', 8581575196))
YOUR_USERNAME = os.getenv('YOUR_USERNAME', 'useless')
UPDATE_CHANNEL = os.getenv('UPDATE_CHANNEL', 'xcy_live_1k')
...
def _logic_help(message):
    help_text = """
🤖 **USELESS Hosting Bot Help Guide**
...
if __name__ == '__main__':
    logger.info("="*50 + "\n🤖 USELESS Hosting Bot Starting Up...\n" + f"🐍 Python: {sys.version.split()[0]}\n" +
